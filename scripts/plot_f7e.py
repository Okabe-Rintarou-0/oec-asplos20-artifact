...
if len(sys.argv)==3:
  ...
  print("Usage: python3 plot_f7e.py /path/to/src/ /path/to/dst/")
  exit()

# Baseline
base_xvalues = []
base_yvalues = []
with open(src+'sim-compose/logs/csfp-latency.csv','r') as infile:
...
mcap_xvalues = []
mcap_yvalues = []
# with open(src+'sim-compose/logs/cstp-latency.csv','r') as infile:
#   lines = infile.readlines()
#   lines = lines[1:]
#   for line in lines:
#     line_split = line.split(',')
